...
columns = [
    'p_change', 'volume', 'ma5', 'ma10', 'ma20', 'v_ma5', 'v_ma10', 'v_ma20',
    'turnover'
]
...
raw_data = ts.get_hist_data(
    code=default_code, start=default_start, end=default_end)
before_data = (
    raw_data.loc[:, columns])[predict_days + 1:predict_days + eval_days + 1]
